...
MAINL:  li t2,0xFF200000	# carrega o endereço de controle do KDMMIO ("teclado")
	...
	andi t0,t0,0x0001	# mascara todos os bits de t0 com exceçao do bit menos significativo
  	...
  	addi t4,t4,1		# incrementa o contador de estados do Robozinho (se t4 for par -> Robozinho1; se t4 for impar -> Robozinho2)
...
MOVRGHT:addi s1,s1,-1280
	...
	li t5,2			# t5 = 2 (para verificar a paridade de t4)
...
FIM:	li a0,60		
	li a7,32
	ecall			# serviço 32 do ecall (sleep - a proxima iteraçao demora 60 milissegundos para acontecer)
